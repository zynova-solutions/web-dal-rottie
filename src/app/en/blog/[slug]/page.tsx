...
export default function Page({ params }) {
  // Enable static rendering for English locale
  setRequestLocale('en');
  ...
  return (
    <>
      ...
      <section className="hero relative flex items-center h-[40vh] w-full mb-12">
        ...
        <div className="hero-content container mx-auto px-4">
          <div>
            ...
            <div className="text-gray-200 text-sm mb-2">{new Date(post.date).toLocaleDateString()}</div>
          </div>
        </div>
      </section>
      ...
      <main className="max-w-2xl mx-auto py-8 px-4">
        ...
        <Link href="/en/blog" className="block mt-8 text-blue-600 hover:underline">← Back to Blog</Link>
      </main>
    </>
  );
}
